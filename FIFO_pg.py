...
incomingStream = []
#swap =0
length = int(input("Enter number of elements in page reference string: "))
  
for i in range(0, length):
    ele = int(input('Enter page string : '))  
    incomingStream.append(ele) 

n = len(incomingStream)    

frames = int(input("Enter No. of Page Frames : "))
#frames = 3
